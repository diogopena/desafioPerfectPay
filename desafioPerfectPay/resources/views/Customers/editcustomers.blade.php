...
<html lang="en">
    ...
    <form method="POST" action="{{route('customer.store')}}" class="form-horizontal form-validade">
            ...
            <div class="form-group">
                <label >Nome: </label>
                <input id="name" name="name" required type="text" class="form-control" value="{{old("name",$customer->name)}}">
            </div>
            <div class="form-group">
                <label >Tipo: </label>
                <input id="identification_type" name="identification_type" type="text" class="form-control" value="{{old("identification_type",$customer->identification_type)}}">
            </div>
            <div class="form-group">
